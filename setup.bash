...
setup_venv() {
    ...
    export WORKDIR="${HOME}/.local/${VENV_NAME}_env"   # 
    export TMPDIR="${WORKDIR}/tmp"
    export PIP_CACHE_DIR="${WORKDIR}/pip_cache"

    mkdir -p "${WORKDIR}" "${TMPDIR}" "${PIP_CACHE_DIR}"

    VENV_PATH="${WORKDIR}/${VENV_NAME}"
