...
VL_ATTR_COLD void Vtop_module___024root___ctor_var_reset(Vtop_module___024root* vlSelf) {
    ...
    vlSelf->out_bytes = VL_RAND_RESET_I(24);
    vlSelf->done = VL_RAND_RESET_I(1);
    vlSelf->top_module__DOT__state = VL_RAND_RESET_I(2);
    vlSelf->top_module__DOT__next = VL_RAND_RESET_I(2);
    vlSelf->top_module__DOT__out_bytes_r = VL_RAND_RESET_I(24);
